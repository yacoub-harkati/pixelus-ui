...
export default function Timer({ className }: Props) {
  return (
    <div
      className={`rounded-2xl bg-gradient-to-r from-orange-default to-indigo p-[1px] ${className}`}
    >
      <div className="flex flex-wrap items-center justify-center gap-1 rounded-2xl bg-primary-light py-2 px-1 text-xs dark:bg-primary-dark md:gap-2 md:text-base">
